...
$installer->setConfigData('advanced/modules_disable_output/Arun_Banners','0');
$installer->setConfigData('banners/general/banner_width','685');
$installer->setConfigData('banners/general/banner_height','250');
